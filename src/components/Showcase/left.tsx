  ...
  return (
    <div className="py-2 flex-1 flex flex-col items-start justify-center gap-3">
      ...
      <p className="text-[2rem] lg:text-[4rem] font-bold tracking-wide text-headingColor">
        ...
        <span className="text-red-600 text-[2.5rem] lg:text-[4.6rem]"> Accra</span>
      </p>
      ...
      <motion.button
        ...
        className="text-white bg-gradient-to-br from-red-400 to-red-500 w-full md:w-auto px-4 py-2 rounded-lg hover:shadow-lg transition-all ease-in-out duration-100"
      >
        Order Now
      </motion.button>
    </div>
