...
import { HiOutlineMenuAlt2 } from "@assets/icons";
    ...
    <header className="w-screen fixed z-50 bg-cardOverlay backdrop-blur-md md:p-3 md:px-4 lg:p-6 lg:px-16">
      ...
      <div className="hidden md:flex w-full justify-between itesm-center">
        <Link to={"/"}>
          ...
          >
            <img src={Logo} alt="Logo" className="md:w-12 lg:w-14 object-cover" />
            <p className="text-red-700 md:text-lg lg:text-xl font-bold">
              Foody
            </p>
          </motion.div>
        </Link>
          ...
          <div className="p-5 flex items-center justify-between w-full">
            ...
            <Link to={"/"}>
              ...
              >
                ...
                <p className="text-red-700 text-xl font-bold">Foody</p>
              </motion.div>
            </Link>
            {user ? (
              <div
