      ...
      <div className="min-h-[50vh] mt-5">
        ...
        <div className="w-full flex items-center justify-center mt-4">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center justify-center gap-2 w-[90%] p-2 rounded-full bg-gradient-to-tr from-red-400 to-red-600 hover:from-red-600 hover:to-red-400 transition-all duration-75 ease-in-out text-gray-50 text-lg my-2 hover:shadow-lg"
          >
