...
const User = ({item}: {item:any}) => {
  return (
    <div className="max-w-sm h-auto rounded-lg border border-red-50 bg-red-600">
    <div className="flex flex-col gap-1 items-center pb-10">
      ...
      <motion.div whileTap={{scale:1.1}} className="gap-2 text-red-600 text-sm p-1 px-3 bg-primary shadow-lg rounded-lg flex items-center justify-center mt-2 -mb-2">
        {
