      ...
      <div className="border w-full  flex border-gray-300 items-center rounded-lg p-4 flex-col justify-center gap-4  ">
        ...
        <div className="w-full flex items-center justify-center">
          <motion.button
            ...
            className="ml-0 flex justify-center items-center gap-2 flex-row-reverse md:ml-auto w-full md:w-auto border-none outline-none rounded bg-red-500 px-12 py-2 text-lg text-white"
            onClick={() => saveItem()}
          >
